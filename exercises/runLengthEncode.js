...
/*
  ...
  ** Hint #1 **
  As is often the case, other languages have built in methods that will iterate
  over each character of an array.  In JavaScript, you have to use a for loop to
  accomplish this.
  ...
  This function will print out each character of the string used.

  Write some of your own "sanity checks" here.  Each check should look like:

   console.log(runLengthEncode(); == ...expected return value...);
