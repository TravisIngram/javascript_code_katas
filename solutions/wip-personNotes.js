/*
  ** Note #1 **
  Since JavaScript doesn't explicitly have classes, not in the same way or
  sense that a language like Ruby or Python does, this exercise isn't able to
  be directly transferred.

  It's a work in progress, though, and will hopefully be fleshed out soon.

  Classes: Person

  We're going to learn how to define classes in JavaScript and create custom
  JavaScript objects from those classes.
